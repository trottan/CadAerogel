...
echo ' <volume name="TedlarWrapping" color="444444" style="0" material="G4_AIR" position="0.000000*cm 0.000000*cm 0.000000*cm" rotation="0 0 0" mother="OpticalGasVolume" /> ' >> cad.gxml

echo ' <volume name="MirrorBack1" color="777777" style="0" material="G4_Pyrex_Glass" position="0.000000*cm 0.000000*cm 0.000000*cm" rotation="0 0 0" mother="OpticalGasVolume" sensitivity="mirror: rich_AlMgF2" hitType="rich" identifiers="id manual 31" /> ' >> cad.gxml
echo ' <volume name="MirrorBack2" color="777777" style="0" material="G4_Pyrex_Glass" position="0.000000*cm 0.000000*cm 0.000000*cm" rotation="0 0 0" mother="OpticalGasVolume" sensitivity="mirror: rich_AlMgF2" hitType="rich" identifiers="id manual 32" /> ' >> cad.gxml
